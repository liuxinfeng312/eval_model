...
#   if torch.cuda.is_available():
  #      device = torch.device(0)
   # else:
    ...
    tokenizer = AutoTokenizer.from_pretrained("/data/app/user_data/muzhili/llama2/Llama-2-7b-chat-hf")
    tokenizer.pad_token_id = 0
    tokenizer.bos_token_id = 1
    tokenizer.eos_token_id = 2
    tokenizer.padding_side = "left"
    model_config = AutoConfig.from_pretrained("/data/app/user_data/muzhili/llama2/Llama-2-7b-chat-hf")

    
    model = AutoModelForCausalLM.from_pretrained("/data/app/user_data/muzhili/llama2/Llama-2-7b-chat-hf", torch_dtype=load_type, config=model_config, device_map='auto')
...
def main():
    ...
    with open('1_res_chat.csv','w',encoding='utf-8',newline='') as f:
        writer = csv.writer(f)
